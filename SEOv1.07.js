javascript:(function() {
    ...
    var stopWords = ['the', 'and', 'a', 'an', 'in', 'on', 'at', 'of', 'for', 'to', 'is', 'with', 'by', 'this', 'that', 'it', 'as', 'be', 'are', 'was', 'were', 'will', 'would', 'can', 'could', 'has', 'have', 'had', 'from', 'or', 'but', 'not', 'so', 'if', 'up', 'down', 'over', 'under', 'between', 'among', 'into', 'through', 'during', 'before', 'after', 'above', 'below', 'off', 'on', 'onto', 'beside', 'by', 'near', 'past', 'beyond', 'without', 'within'];
    var wordFrequency = {};
    
    words.forEach(function(word) {
        if (stopWords.indexOf(word) === -1) { // Exclude stop words and prepositions
